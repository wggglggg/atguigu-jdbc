...
/**
 * ClassName: JdbcStatementLoginPart
 * Description:
 *
 * @Author wggglggg
 * @Create 2023/6/28 14:56
 * @Version 1.0
 */
public class JdbcStatementLoginPart {
    public static void main(String[] args) throws Exception {
         ...
         */
        //获取连接
        Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/jdbc80", "root", "abc123");
